 ...
 */
public abstract class ADataPacketAlgoCmd<R, D, P> implements
		IExtVisitorCmd<R, Class<?>, P, ADataPacket> {
	...
	final public <T extends IExtVisitorHost<Class<?>, ? super ADataPacket>> R apply(
			Class<?> index, T host, P... params) {
	 ...
	 * @return  The result of this case.
	 */
	abstract public R apply(Class<?> index, DataPacket<D> host,
