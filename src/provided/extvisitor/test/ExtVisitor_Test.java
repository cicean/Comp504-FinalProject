...
public class ExtVisitor_Test extends TestCase {
	...
	public void test_HostStr() {
		...
		algo.setCmd("a",
				new IExtVisitorCmd<Integer, String, Integer, HostStr>() {
	...
	public void test_IHostStr() {
		...
		algo.setCmd("HostStr1",
				new IExtVisitorCmd<Integer, String, Integer, AHostStr>() {
	...
	public void test_IHostStr_2() {
		...
		AExtVisitor<Integer, String, Integer, AHostStr> algo = new AExtVisitor<Integer, String, Integer, AHostStr>(
				0) {
	...
	public void test_HostInt() {
		...
		algo.setCmd(42,
				new IExtVisitorCmd<String, Integer, Integer, HostInt>() {
		...
		assertEquals("host99.execute(algo)", "No cmd found!",
				host99.execute(algo));
...
class HostStr implements IExtVisitorHost<String, HostStr> {
	...
	@Override
	public <R, P> R execute(IExtVisitor<R, String, P, ? extends HostStr> algo,
