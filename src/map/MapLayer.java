...
public class MapLayer extends AnnotationLayer implements Serializable {
	 ...
	 */
	private ToggleAnnotation makeAnnotation(String unselectedText,
			String selectedText, Position pos) {
		ToggleAnnotation ta = new ToggleAnnotation(unselectedText,
				selectedText, Position.fromDegrees(pos.getLatitude().degrees,
						pos.getLongitude().degrees, 0));
		return ta;
	}
	 ...
	 * @param pos            - position of annotation
	 */
	public void addToggleAnnotation(String unselectedText, String selectedText,
			Position pos) {
	 ...
	 */
	public void addToggleAnnotation(String unselectedText, String selectedText,
			Position pos, double minAltitude, double maxAltitude) {
		ToggleAnnotation annotation = makeAnnotation(unselectedText,
				selectedText, pos);
	...
	private void writeObject(java.io.ObjectOutputStream out) throws IOException {
		...
		for (Annotation annotation : this.getAnnotations()) {
			if (annotation instanceof ToggleAnnotation) { // must check this before GlobeAnnotation
				...
				annotations.add(new ToggleAnnotation(
	...
	private void readObject(java.io.ObjectInputStream in) throws IOException,
		...
		Vector<ToggleAnnotation> annotations = (Vector<ToggleAnnotation>) in
				.readObject();
