 ...
 */
public class ToggleAnnotation extends DummyGlobeAnnotation implements
		Serializable {
	 ...
	 */
	public static final Color DEFAULT_SELECTED_BACKGROUND_COLOR = new Color(0f,
			.5f, 0f, .5f);
	 ...
	 */
	public ToggleAnnotation(String unselectedText, String selectedText,
			Position pos) {
		this(unselectedText, selectedText, pos,
				new DefaultAnnotationAttributes());
	 ...
	 */
	public ToggleAnnotation(String unselectedText, String selectedText,
			Position pos, AnnotationAttributes attr) {
	...
	public ToggleAnnotation(ToggleAnnotation ta) {
		this(ta._unselectedText, ta._selectedText, ta.getPosition(), ta
				.getAttributes());
	...
	public ToggleAnnotation(GlobeAnnotation annotation) {
		this(annotation.getText(), annotation.getText(), annotation
				.getPosition(), annotation.getAttributes());
	...
	@Override
	public String toString() {
		return "\"" + this.getText() + "\"/\"" + _selectedText + "\"@("
				+ this.getPosition() + ", " + this.getAttributes();
	}
...
class DummyGlobeAnnotation extends GlobeAnnotation {
	 ...
	 */
	public DummyGlobeAnnotation(String unselectedText, Position pos,
