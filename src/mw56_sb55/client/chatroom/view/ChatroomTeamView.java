...
public class ChatroomTeamView<T> extends JFrame {
	...
	/** Serial ID */
	   ...
	   */
	  public ChatroomTeamView(IViewToChatroomAdapter modelAdapter) {
...
//	  }
	...
	public void updateUserList(Collection<ChatUser> userStubList) throws Exception {
		// TODO Auto-generated method stub
		userList.removeAll();
		userlistModel = new DefaultListModel<String>();
		for (ChatUser user : userStubList) {
...
//	public void refreshMemberList(Set<IChatUser> memberStubList){
//		userList.removeAll();
//		String[] memberStubArray = new String[memberStubList.size()];
//		Iterator<IChatUser> it = memberStubList.iterator();
//		int i=0;
//		while (it.hasNext()) {
//			try {
